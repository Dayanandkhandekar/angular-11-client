...
} from '../../../../angular-11-client/src/app/view/content/crud';
...
export class LayoutUtilsService {
	...
	showActionNotification(
		...
		_horizontalPosition: 'left' | 'right' = 'right',
		_class:'success' | 'warning' = 'success'
	) {
		const _data = {
			message: _message,
	...
	updateStatusForEntities(title: string = '', description: string = '', waitDesciption: string = '') {
			return this.dialog.open(UpdateStatusDialogComponent, {
				data: { title, description,waitDesciption},
				width: '440px'
			});
	...
	// changePasswordFormElement(_data) {
	 ...
	 */
	// resetPasswordFromElement(_data){
	// 	return this.dialog.open(ResetPasswordDialogComponent,{
	// 		data: _data,
	// 		width:'400px'
	// 	});
	// }
